            ...
            <div class="row">
                <div class="col-12">
                    <div class="product-info">
                        ...
                        <a href="#">
                        <img class="default-img" src="{{$product->photoone}}" alt="#">
                        <img class="hover-img" src="{{$product->photoone}}" alt="#">
                        ...
                        <a title="Add to cart" href="{{route('zajil.cart.add', $product->id)}}">Add to cart</a>
                        </div>
                        </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row no-gutters">
                        <div class="col-lg-6 offset-lg-3 col-12">
                            ...
                            <h3 style="font-size:30px;color:#333;">test<h3>
