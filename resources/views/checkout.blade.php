                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" placeholder="{{\Illuminate\Support\Facades\Auth::user()->name ?? 'Not Register Or Login !'}}" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" placeholder="{{\Illuminate\Support\Facades\Auth::user()->email}}" required="required">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                ...
                <div class="col-lg-4 col-12">
                    <div class="order-details">
                        ...
                        <div class="single-widget payement">
                            <div class="content">
                                <img src="{{asset('assets/user/images/payment-method.png')}}" alt="#">
                            </div>
                        </div>
                        ...
                        <div class="single-widget get-button">
                            <div class="content">
                                <div class="button">
                                    <form action="{{route('zajil.payCheckOut')}}" method="post">
                                        @csrf
    ...
    @else
        <div class="container">
            <div class="alert alert-danger mt-5 mb-5" role="alert">
                User Not login Yet ! Please <a href="/login" style="color: red">Sign In</a> Now
            </div>
        </div>
