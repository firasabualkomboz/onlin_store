                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-5 pl-2">
                                        <h4>Category</h4>
                                        <h6 class="text-muted">All languages</h6>
                                    </div>
                        ...
                        <div class="card-content">
                            <div class="card-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-5 text-right">
                                        <h4>Count</h4>
                                        <h6 class="success darken-4">{{\App\Models\Product::count()}}<i class="la la-arrow-up"></i></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="card-content">
                            <div class="card-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-5 text-right">
                                        <h4>Count</h4>
                                        <h6 class="danger">{{\App\Models\Order::count()}} <i class="la la-arrow-down"></i></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
{{--
            ...
            <div class="row match-height">
                <div class="col-12 col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">منتجات تم طلبها </h4>
                ...
                <div class="col-12 col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">تم البيع </h4>
                            <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
