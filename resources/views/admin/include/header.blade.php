<nav
    ...
    <div class="navbar-wrapper">
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <h3 class="brand-text">لوحة التحكم الرئيسية</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">ويلكم
                  <span
                      class="user-name text-bold-700"> feras anwer </span>
                </span>
 ...
 --}}
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">عرض جميع الأشعارات</a>
                            </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="admin/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">عرض جميع الرسائل</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
